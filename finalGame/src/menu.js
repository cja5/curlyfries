...
class Menu {
    constructor(socket) {
        this.playerName = prompt("Enter your name:", "Red Boi");
        this.socket = socket;
    ...
    red() { //Start as a red boi
        this.game = new Game(1, this.socket, this, this.playerName);  //Creates a game
    ...
    blue() { //Start as a blue boi
        this.game = new Game(2, this.socket, this, this.playerName);
        this.socket.emit('New player', 'Blue boi', 2, 3800, 950, 5);
        this.gameStarted = true;
    }

    spectator() { //Start as a spectator
        this.game = new Game(3, this.socket, this, this.playerName);
